        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.companyService.find(id).subscribe((company) => {
                    company.createTime = this.datePipe
                        .transform(company.createTime, 'yyyy-MM-ddTHH:mm:ss');
                    company.updateTime = this.datePipe
                        .transform(company.updateTime, 'yyyy-MM-ddTHH:mm:ss');
